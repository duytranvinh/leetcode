...
**Companies**:  
[Expedia](https://leetcode.com/company/expedia), [Goldman Sachs](https://leetcode.com/company/goldman-sachs)
...
class Solution:
    def maxArea(self, h: int, w: int, horizontalCuts: List[int], verticalCuts: List[int]) -> int:
        #Sort two arrays
        #Find the largest cut for horizontal and vertical
        #Multiple them to get the area
        horizontalCuts.sort()
        verticalCuts.sort()
        #Add two end to the array
