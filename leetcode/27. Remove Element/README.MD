...
**Companies**:
[Adobe](https://leetcode.com/company/adobe), [Apple](https://leetcode.com/company/apple), [Amazon](https://leetcode.com/company/amazon), [Bloomberg](https://leetcode.com/company/bloomberg), [Uber](https://leetcode.com/company/uber), [Facebook](https://leetcode.com/company/facebook), [Google](https://leetcode.com/company/google), [Microsoft](https://leetcode.com/company/microsoft), [Yahoo](https://leetcode.com/company/yahoo), [Yandex](https://leetcode.com/company/yandex)
...
Keep track of "valid index" when loop through the array.

If the number is valid, then we assign it into the "valid index" and increase valid index

If not, we just go next without increasing the valid index
