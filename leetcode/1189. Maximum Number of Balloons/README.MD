...
**Companies**:
[Tesla](https://leetcode.com/company/tesla), [Microsoft](https://leetcode.com/company/microsoft), [Amazon](https://leetcode.com/company/amazon), [Wayfair](https://leetcode.com/company/wayfair)
...
class Solution:
    def maxNumberOfBalloons(self, text: str) -> int:
         countText, countBallon = defaultdict(int) , defaultdict(int)
         for c in text:
           countText[c] += 1
         for c in 'balloon':
           countBallon[c] += 1
         res = len(text)
         for c, val in countBallon.items():
           res = min(res, countText[c] // val)
         return res
